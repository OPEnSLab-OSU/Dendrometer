...
// MY NOTES: go to here: https://openslab-osu.github.io/Loom/html/class_loom___s_h_t31_d.html#a619316ba7f1731007a0e6a7472be2ebf, look at constructor and parameters, this is doxygen documentation 
// go to loom module factory in library for names of things
...
void loop() 
{
  ...
  Loom.package();
  Loom.display_data();
  //JsonObject package = Loom.package(); //creates object called package
  // for getting loom data call array similar to below, but data = package[ blah 
  //package["components"][0]["number"] = 0; // assigns data spot in loom
